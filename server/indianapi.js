...
const INDEX_META = {
    NIFTY:     { name: 'NIFTY 50',          yahoo: '^NSEI',                lot_size: 25, strike_gap: 50,  basePrice: 24856.30 },
    SENSEX:    { name: 'SENSEX',            yahoo: '^BSESN',               lot_size: 10, strike_gap: 100, basePrice: 81542.75 },
    FINNIFTY:  { name: 'NIFTY FIN SERVICE', yahoo: 'NIFTY_FIN_SERVICE.NS', lot_size: 25, strike_gap: 50,  basePrice: 23180.60 },
    BANKNIFTY: { name: 'NIFTY BANK',        yahoo: '^NSEBANK',             lot_size: 15, strike_gap: 100, basePrice: 51000.00 }
};
